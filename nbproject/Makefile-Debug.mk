...
${OBJECTDIR}/beeiotgw/BIoTAES.o: beeiotgw/BIoTAES.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/beeiotgw/BIoTAES.o beeiotgw/BIoTAES.cpp
...
${OBJECTDIR}/beeiotgw/BIoTCrypto.o: beeiotgw/BIoTCrypto.cpp
	${MKDIR} -p ${OBJECTDIR}/beeiotgw
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/beeiotgw/BIoTCrypto.o beeiotgw/BIoTCrypto.cpp

${OBJECTDIR}/beeiotgw/BIoTcmac.o: beeiotgw/BIoTcmac.cpp
	${MKDIR} -p ${OBJECTDIR}/beeiotgw
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/beeiotgw/BIoTcmac.o beeiotgw/BIoTcmac.cpp
...
${OBJECTDIR}/beeiotgw/getini.o: beeiotgw/getini.c
	${MKDIR} -p ${OBJECTDIR}/beeiotgw
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/beeiotgw/getini.o beeiotgw/getini.c
...
${OBJECTDIR}/beeiotgw/ini.o: beeiotgw/ini.c
	${MKDIR} -p ${OBJECTDIR}/beeiotgw
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/beeiotgw/ini.o beeiotgw/ini.c
